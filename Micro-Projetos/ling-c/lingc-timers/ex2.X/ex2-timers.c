...
#define Resol_PWM1 250 //PWM1 com 100 passos temporais de resolução 
...
ISR(TIMER0_OVF_vect) { 
   TCNT0 = 128; //Recarrega o timer para garantir a próxima interrupção com 10us 
...
int main() { 
    ...
    TCNT0 = 128; //Inicia a contagem em 96 para gerar a interrupção a cada 10us 
